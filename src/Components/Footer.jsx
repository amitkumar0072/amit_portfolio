...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center pb-10 bg-[#0a0909] text-gray-300">
      {/* Copyright */}
      <p className="text-xs">Amit Kumar © 2025</p>
      ...
      <ul className="mx-auto flex items-center justify-center gap-6 text-[#b0b2c3]">
        <li>
          <a
            href="https://www.linkedin.com/in/amit-kumar-92111b241/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
              className="w-4 text-blue-500 hover:text-blue-700"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              fill="currentColor"
            >
        ...
        <li>
          <a
            href="https://www.instagram.com/amit_thenua11/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
  ...
  strokeWidth="40"
        ...
        <li>
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=a_kumar1@bt.iitr.ac.in&su=Hello%20Amit"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
